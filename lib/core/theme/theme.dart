...
ThemeData buildAppTheme() {
  ...
  final bodyMedium = TextStyle(fontFamily: fontFamily, fontSize: 16.sp, fontWeight: FontWeight.w500);
  final bodySmall = TextStyle(fontFamily: fontFamily, fontSize: 14.sp, fontWeight: FontWeight.w300);

  final headLineMedium = TextStyle(fontFamily: fontFamily, fontSize: 18.sp, fontWeight: FontWeight.w500);
  final headLineSmall = TextStyle(fontFamily: fontFamily, fontSize: 13.sp, fontWeight: FontWeight.w400);
  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      hintStyle: bodyLarge.copyWith(color: greyA9),
      labelStyle: bodyLarge.copyWith(color: greyA9),
